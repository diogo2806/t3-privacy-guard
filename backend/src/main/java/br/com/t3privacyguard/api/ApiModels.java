...
public final class ApiModels {
    private ApiModels() {}
    public record CreateIncidentRequest(@NotBlank @Size(max=160) String title,@NotNull Severity severity,@NotBlank @Size(max=2000) String summary,@NotBlank @Size(max=120) String source) {}
    ...
    public record CreateActionRequest(@NotBlank @Size(max=128) String requestId,@NotBlank @Size(max=80) String action,@NotBlank @Size(max=240) String resource,@NotBlank @Size(max=80) String purpose,@Size(max=253) String host,@NotNull @Size(max=64) List<@NotBlank @Size(max=80) String> fields) {}
