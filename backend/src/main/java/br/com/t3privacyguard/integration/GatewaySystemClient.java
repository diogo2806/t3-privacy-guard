...
public class GatewaySystemClient {
    ...
    public Optional<TenantStatus> tenantStatus() {
        return get("/internal/t3n/status", TenantStatus.class);
    }

    public Optional<AgentStatus> agentStatus() {
        return get("/internal/agent/status", AgentStatus.class);
    }
    ...
    public record ContractIdentity(String contractId, String contractVersion, List<String> functions) {}
}
