      ...
      <section ref={dialogRef} tabIndex={-1} className="modal-panel" role="dialog" aria-modal="true" aria-labelledby="screen-manual-title" aria-describedby="screen-manual-purpose">
        ...
        <div className="manual-content">
          ...
          <section>
            ...
            <p>Os estados são deliberadamente conservadores. Antes de análise aparece <strong>NOT YET OBSERVED</strong>. <strong>DENY</strong> resulta em <strong>BLOCKED BEFORE PROTECTED EGRESS</strong>; <strong>REDACT</strong> em <strong>MINIMIZATION REQUIRED</strong>; <strong>ALLOW</strong> sem aprovação em <strong>HUMAN AUTHORIZATION REQUIRED</strong>; aprovação sem side effect em <strong>AUTHORIZED / NOT EXECUTED</strong>; <strong>PENDING_VERIFICATION</strong> em <strong>ACCEPTED / NOT VERIFIED</strong>; <strong>UNVERIFIED</strong> e <strong>FAILED</strong> nunca são apresentados como sucesso. Somente <strong>COMPLETED</strong> após read-back independente permite <strong>VERIFIED EXTERNAL STATE</strong>.</p>
            <p><strong>Proof at a glance</strong> não substitui o Evidence Center. Source commit, source tree, network, contract version e totais PASS/FAIL/NOT RUN só aparecem como proof quando um bundle T3N testnet válido foi carregado. Sem bundle, a tela informa <strong>Live evidence not loaded/generated</strong> e não fabrica LIVE, PASS ou commit. <strong>T3N LIVE / READY</strong> exige simultaneamente protected remediation ready no System Status e evidence válida. Proposal DID e Executor DID são encurtadas apenas visualmente; o valor completo permanece no atributo de detalhe. <strong>SEPARATE</strong>, <strong>CONFIRMED</strong> e <strong>REGISTERED</strong> só aparecem quando os estados reais permitem essa afirmação.</p>
          ...
          <section>
            ...
            <p>1. Entre na aplicação. 2. Use <strong>Executive demo</strong> quando precisar explicar em uma única tela risco, decisão, autoridade, outcome e proof, sem disparar ações. 3. Em <strong>Protection flow</strong>, leia readiness, Current result e Business Outcome. 4. Escolha o cenário e revise o prompt. 5. Use <strong>Analyze with agent</strong>. 6. Confira proposta e decisão. 7. Compare <strong>Allowed for egress</strong> com <strong>Removed before egress</strong>. 8. Em ALLOW ou REDACT executável, registre autorização humana quando exigida e confirme <strong>Authorized by/Authorized at</strong>. 9. Execute pelo Protected Executor. 10. Verifique o estado externo. 11. Volte à Executive Demo para confirmar que somente o estado realmente observado foi projetado. 12. Em Evidence, leia summary e outcomes antes da provenance técnica.</p>
          </section>
          <section>
