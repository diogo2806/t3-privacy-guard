      ...
      <section ref={dialogRef} tabIndex={-1} className="modal-panel" role="dialog" aria-modal="true" aria-labelledby="screen-manual-title" aria-describedby="screen-manual-purpose">
        ...
        <div className="manual-content">
          ...
          <section>
            ...
            <p>1. Entre na aplicação. 2. Leia T3N readiness e <strong>Enterprise integration</strong>; só considere o protected workflow pronto quando ambos estiverem prontos. 3. Leia <strong>Current result</strong> e <strong>Business Outcome</strong>. 4. Escolha o cenário e revise o prompt. 5. Use <strong>Analyze with agent</strong>. 6. Volte ao Business Outcome para conferir risco/controle observado. 7. Inspecione <strong>Requested fields</strong>, decisão e <strong>Approved destination</strong>. 8. Compare <strong>Allowed for egress</strong> com <strong>Removed before egress</strong>. 9. Confira <strong>Trusted synthetic values</strong> e <strong>Protected egress payload</strong>. 10. Em ALLOW ou REDACT executável, registre autorização humana quando exigida e confirme <strong>Authorized by/Authorized at</strong>. 11. Execute pelo Protected Executor. 12. Verifique o estado externo e confirme que Business Outcome só mostra resultado verificado após read-back. 13. Em Evidence, leia summary e outcomes antes da provenance técnica.</p>
          </section>
          <section>
