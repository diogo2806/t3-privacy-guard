      ...
      <section ref={dialogRef} tabIndex={-1} className="modal-panel" role="dialog" aria-modal="true" aria-labelledby="screen-manual-title" aria-describedby="screen-manual-purpose">
        ...
        <div className="manual-content">
          ...
          <section>
            ...
            <p>1. Entre na aplicação. 2. Leia o readiness e o <strong>Current result</strong> no Trust Flow. 3. Abra <strong>System readiness details</strong> quando precisar diagnosticar Tenant, Proposal Agent, Protected Executor, grants ou acesso efetivo. 4. Em <strong>Protection flow</strong>, escolha o cenário e revise o prompt. 5. Use <strong>Analyze with agent</strong>. 6. Inspecione proposta, decisão e <strong>Approved destination</strong>. 7. Se houver DENY no cenário de credencial comprometida, use <strong>Prepare safe path</strong> para criar somente a proposta mínima. 8. Se a policy estiver PENDING, use o retry dentro da etapa Policy. 9. Em ALLOW, registre autorização humana quando exigida. 10. Confirme novamente o Approved destination e execute pelo Protected Executor. 11. Verifique o estado externo. 12. Em <strong>Evidence</strong>, leia summary e outcomes antes de abrir provenance técnica. A2A pode reproduzir somente a etapa pública de proposta/avaliação.</p>
          </section>
          <section>
