      ...
      <section ref={dialogRef} tabIndex={-1} className="modal-panel" role="dialog" aria-modal="true" aria-labelledby="screen-manual-title" aria-describedby="screen-manual-purpose">
        ...
        <div className="manual-content">
          ...
          <section>
            ...
            <p><strong>Member grant</strong> é o estado observado no documento de Member Delegation do tenant. Ele mostra se há grant e sua janela temporal, mas sozinho não prova que uma chamada concreta será autorizada. <strong>Effective T3N access</strong> é verificado separadamente com <code>checkDelegation</code> pelo cliente autenticado do próprio Proposal Agent ou Protected Executor, usando o contrato exato, a Tenant DID canônica e apenas as funções/scopes mínimos exigidos. <strong>Confirmed</strong> exige resposta efetiva autorizada; <strong>Denied</strong> significa rejeição efetiva; <strong>Unknown</strong> significa que a verificação falhou ou foi inconclusiva. Denied e Unknown sempre fecham o fluxo em segurança.</p>
            <p><strong>Registered</strong> significa que um Agent Card público válido foi resolvido para exatamente a mesma Proposal Agent DID. <strong>Card check</strong> é o momento da última tentativa de consulta e validação do Agent Card; esse timestamp também existe para <strong>NOT REGISTERED</strong>, <strong>CARD/DID MISMATCH</strong> e <strong>UNAVAILABLE</strong>, portanto não significa verificação bem-sucedida. Proposal e Executor possuem Member Delegations e verificações efetivas independentes. Registrar o Agent Card aumenta descoberta pública, mas não concede acesso ao contrato. Avaliação só é considerada pronta quando o Proposal Agent possui Member grant ativo e acesso efetivo confirmado. Remediação protegida exige, adicionalmente, o mesmo para o Protected Executor.</p>
