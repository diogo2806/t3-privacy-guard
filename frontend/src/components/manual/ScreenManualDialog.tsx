      ...
      <section ref={dialogRef} tabIndex={-1} className="modal-panel" role="dialog" aria-modal="true" aria-labelledby="screen-manual-title" aria-describedby="screen-manual-purpose">
        ...
        <div className="manual-content">
          ...
          <section>
            ...
            <p><strong>Protection flow</strong> contém cenário, prompt, proposta, decisão, payload minimizado, autorização, execução, verificação, retenção e activity rail. <strong>Requested fields</strong>, <strong>Allowed for egress</strong>, <strong>Removed before egress</strong>, <strong>Trusted synthetic values</strong> e <strong>Protected egress payload</strong> explicam a minimização. Para <code>notify-security</code>, a aplicação carrega apenas a referência lógica <code>verified_email</code>.</p>
          ...
          <section>
            ...
            <p><strong>Business Outcome</strong> deriva risco, ação, policy, autorização, execução e verificação do estado observado. <strong>Time to policy decision</strong> usa <code>decision.evaluatedAt - action.createdAt</code>. <strong>Time to verified outcome</strong> só existe em COMPLETED e usa <code>remediation.completedAt - action.createdAt</code>. O produto não inventa ROI, breach evitado ou economia financeira.</p>
          </section>
