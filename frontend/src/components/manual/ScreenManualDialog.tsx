        ...
        <div className="modal-backdrop" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && close()}>
          <section className="modal-panel" role="dialog" aria-modal="true" aria-labelledby="screen-manual-title" aria-describedby="screen-manual-purpose">
            ...
            <div className="manual-content">
              ...
              <section><h3>Messages and errors</h3><p>Provider or T3N failures fail closed. A 401 means session/internal authentication is missing; 403 means authorization/CSRF/capability does not allow an action; replay is rejected as conflict. An ambiguous execution is shown as UNVERIFIED and is not automatically retried. Error messages never expose provider keys, T3N keys, profile values, request/response bodies or raw headers.</p></section>
            </div>
          </section>
        </div>
      )}
