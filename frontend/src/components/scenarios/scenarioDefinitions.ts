...
export const ENTERPRISE_SCENARIOS: readonly EnterpriseScenarioDefinition[] = [
  {
    ...
    businessOutcome: 'Revoke the compromised credential without exposing remediation secrets.',
  ...
  },
  {
    ...
    businessOutcome: 'Require independent policy evaluation before account isolation can be claimed.',
  ...
  },
  {
    ...
    businessOutcome: 'Use a logical private reference instead of exposing the plaintext contact value.',
